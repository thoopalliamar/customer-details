...
public class DataLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		employeeservice.saveEmp(new Employee(101L, 152944L,"fresher", "sai saketh", "", "master_card", "10/24", "public", "direct", "direct", 2));
		employeeservice.saveEmp(new Employee(102L, 152945L,"senior", "vishnu vardhan", "", "visa", "1/26", "private", "direct", "direct", 2));
		...
		employeeservice.saveEmp(new Employee(105L, 152948L,"fresher", "saisree", "", "master_card", "8/29", "public", "direct", "direct", 2));
